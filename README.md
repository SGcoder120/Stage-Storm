...
- [x] Custom dark-blue theme and styling updates
...
1. Install dependencies:
   ...
   npm install
   ```
2. Configure the database connection in `server/.env` (PGUSER, PGPASSWORD, PGHOST, PGPORT, PGDATABASE).
3. Create and seed tables:
   ```bash
